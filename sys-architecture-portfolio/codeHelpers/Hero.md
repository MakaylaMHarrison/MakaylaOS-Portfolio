      ...
      <div className="relative group p-[1px] bg-cyan-950/30">
        ...
        <div className="relative flex items-stretch bg-[#020617]/95 backdrop-blur-3xl overflow-hidden border border-white/10">
          ...
          <div className="w-[35%] p-6 flex items-center justify-center relative">
            <div className="relative w-full aspect-square border border-cyan-500/40 p-1 bg-cyan-900/20 shadow-[0_0_20px_rgba(34,211,238,0.1)]">
              <img
                src={avatar}
                alt="avatar"
                className="w-full h-full object-cover brightness-110 contrast-125 rounded-md"
              />
          ...
          <div className="w-[65%] flex flex-col justify-center py-8 pr-10 font-mono">
            ...
            {/* User Data Row */}
            <Motion.div
                initial={{ opacity: 0, x: -20}} // Reduced travel distance for a tighter feel
            ...
            >
              <div className="flex items-baseline">
                ...
                <span className="text-white text-2xl font-light tracking-tight drop-shadow-[0_0_10px_rgba(255,255,255,0.2)] ml-2">
                  {name}
                </span>
              </div>
              <Motion.div 
            ...
            >
              <div className="flex items-baseline">
                ...
                <span className="text-slate-200 text-2xl font-light tracking-wide ml-2">
                  {role}
                </span>
              </div>
              <Motion.div
            ...
            >
              <span className="text-green-500 uppercase text-sm tracking-[0.3em] font-bold opacity-80 w-20 shrink-0">
                Status:
              </span>

              <div className="flex items-baseline leading-none ml-2">
                <span className="text-green-400 text-2xl font-mono tracking-tighter whitespace-nowrap">
                  Building Systems
                </span>
          ...
          <div className="w-[65%] flex flex-col justify-center py-8 pr-10">
            ...
            <Motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ type: "spring", delay: 1.1 }} className="flex items-center">
              ...
              <div className="flex items-baseline leading-none ml-2">
                ...
                <div className="flex ml-1">
                  {[0, 1, 2].map((i) => (
                    <Motion.span key={i} animate={{ opacity: [0, 1, 0] }} transition={{ repeat: Infinity, duration: 3, delay: i * 0.2 }} className="text-green-400">.</Motion.span>
                  ))}
                </div>
              </div>
            </Motion.div>

            {/* INJECTED: About Me Section placed cleanly under the closing Status row div */}
            <Motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 1.2 }}
              className="mt-6 pt-4 border-t border-cyan-500/20 font-mono w-full"
            >
              <div className="flex items-start">
                <span className="text-cyan-400 uppercase text-xs tracking-[0.3em] font-bold opacity-80 pt-0.5 shrink-0 w-20">
                  BIO //:
                </span>
                <p className="text-slate-300 text-xs font-mono leading-relaxed tracking-wide font-light pl-2 text-left">
                  I build systems shaped by human principles, resilience, growth, and adaptability. I translate complex ideas into intuitive, reliable, and empowering digital architectures.
                </p>
              </div>
            </Motion.div>
